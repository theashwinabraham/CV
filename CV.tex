...
\cventry{\small{Research Internship}}{\small{Prof. Parosh Abdulla, Uppsala University; Prof. Ashutosh Gupta, Prof. Krishna S, IIT Bombay}}{Parametrized Verification of Concurrent Systems via View Abstraction}{Summer 2023}{}{
  \begin{itemize}
    \item Read and implemented a \bgroup\color{blue}\href{https://link.springer.com/article/10.1007/s10009-015-0406-x}{paper}\egroup\  describing a new approach to Parametrized Verification through \textit{View Abstraction}
